...
<div class="container-fluid">
    ...
    <br>
    <form>
        <input class="btn btn-primary btn-sm" type="button" value="<--Back"
               onclick="window.location.replace('http://localhost:8080/projects/${project.id}')">
    </form>
    <h3>Edit project</h3>
    <div class="row">
        <div class="col-3">
                ...
                <table id="tb_roles" class="table table-sm">
                    ...
                    <tr>
                        <td style="text-align: center; vertical-align: middle;"><span
                                    class="card-text"><h6>Creator:</h6></span></td>
                        <td><input class="form-control" id="creator" type="text" name="creator" readonly="readonly"
                                   value="${project.creator}"></td>
                    </tr>
                    <tr>
                        <td style="text-align: center; vertical-align: middle;"><span class="card-text"><h6>Project manager:</h6></span>
                        </td>
                        <td>
                    ...
                    <#list project.roleUser as ru>
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="user_member"
                                       value="${ru?keep_after(":")}"></td>
                            <td>
                                <button onclick="deleteRole()" class="btn btn-link btn-sm">
                                    <i style="color: dimgray" class="fa fa-trash" aria-hidden="true"></i>
                                </button>
            ...
            <br>
            <button id="add_role" class="btn btn-primary btn-sm">Add role</button>
            <br><br>
            <button onclick="saveProject()" class="btn btn-success btn-sm">Save</button>
            <br>
        ...
        <div class="col-6">
            ...
            <div class="card">
                ...
                <textarea class="form-control" id="description" name="description"
                          rows="12">${project.description}</textarea>
